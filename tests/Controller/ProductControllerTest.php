...
final class ProductControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'product[designation]' => 'Testing',
            'product[Couleur]' => 'Testing',
            'product[prixUnit]' => 'Testing',
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'product[designation]' => 'Something New',
            'product[Couleur]' => 'Something New',
            'product[prixUnit]' => 'Something New',
        ...
        self::assertSame('Something New', $fixture[0]->getPrixUnit());
